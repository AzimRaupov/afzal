...
<head>
    ...
    <meta property="og:image" content="https://afzal.uz/file/logo_afzal.png">
    <meta property="og:url" content="https://afzal.uz/">
    <meta property="og:site_name" content="Afzal Education Center">

    <link rel="shortcut icon" href="file/logo_afzal.png">
...
<section class="banner py-80 position-relative overflow-hidden">
    ...
    <img src="assets/images/shapes/king.png" alt="" class="shape five animation-walking">
            ...
            <div class="col-xl-6">
                <div class="banner-content pe-md-4">
                    <div class="flex-align gap-8 mb-16" data-aos="fade-down">
                        ...
                        <h5 class="text-main-600 mb-0"> Ваше будущее, добейтесь успеха</h5>
                    </div>

                    <h1 class="display2 mb-24 wow bounceInLeft">Найди свой <span class="text-main-two-600 wow bounceInRight" data-wow-duration="2s" data-wow-delay=".5s">идеальный</span>курс, развивайте <span class="text-main-600 wow bounceInUp" data-wow-duration="1s" data-wow-delay=".5s">навыки</span>
                    </h1>
                    <p class="text-neutral-500 text-line-2 wow bounceInUp">Добро пожаловать в Afza, где обучение не знает границ. Независимо от того, студент ли вы, профессиональный ли специалист или человек, постоянно обучающийся...</p>
                    <div class="buttons-wrapper flex-align flex-wrap gap-24 mt-40">
                        <a href="#courses" class="btn btn-main rounded-pill flex-align gap-8" data-aos="fade-right">
                            Просмотр курсов
            ...
            <div class="col-xl-6">
                <div class="banner-thumb position-relative">
                    ...
                    <div class="banner-box one px-24 py-12 rounded-12 bg-white fw-medium box-shadow-lg d-inline-block" data-aos="fade-down">
                        <span class="text-main-600">500</span> Ученики
                    ...
                    <div class="banner-box three px-24 py-12 rounded-12 bg-white fw-medium box-shadow-lg flex-align d-inline-flex gap-16" data-aos="fade-left">
                        ...
                        <div>
                            <span class="">Онлайн-поддержка</span>
                            <a href="tel:(992)555-0127" class="mt-8 fw-medium text-xl d-block text-main-600 hover-text-main-500">(992) 555-0127</a>
                        </div>
                    </div>
                </div>
            </div>
...
<section class="explore-course py-120 bg-main-25 position-relative z-1" id="courses">
    ...
    <div class="container">
        <div class="section-heading text-center style-flex gap-24">
            <h2 class="mb-0 wow bounceIn">Наши курсы</h2>
                ...
                <div class="row gy-4">
                        ...
                        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                <a href="course-details.html" class="w-100 h-100">
                                    <img src="file/chees.jpg" alt="Course Image" class="course-item__img rounded-12 cover-img transition-2">
                                </a>
                            ...
                            <div class="course-item__content">
                                <div class="">
                                    <h4 class="mb-28">
                                        <a href="course-details.html" class="link text-line-2">Шахматы</a>
                                    </h4>
                            ...
                            <span class="text-neutral-700 text-2xl d-flex">
                                ...
                                <div class="flex-between gap-8 pt-24 border-top border-neutral-50 mt-28 border-dashed border-0">
                                    <h4 class="mb-0 text-main-two-600">50cм</h4>
                                    <a href="#application" class="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabindex="0">
                                        Записатса
                    ...
                    <div class="col-lg-4 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="400">
                        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                <a href="course-details.html" class="w-100 h-100">
                                    <img src="file/lux.jpg" alt="Course Image" class="course-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="flex-align gap-8 bg-main-600 rounded-pill px-24 py-12 text-white position-absolute inset-block-start-0 inset-inline-start-0 mt-20 ms-20 z-1">
                                    <span class="text-2xl d-flex"><i class="ph ph-clock"></i></span>
                            ...
                            <div class="course-item__content">
                                <div class="">
                                    <h4 class="mb-28">
                                        <a href="course-details.html" class="link text-line-2">Люкс - ателье</a>
                                    </h4>
                                    <div class="flex-between gap-8 flex-wrap mb-16">
                            ...
                            <span class="text-neutral-700 text-2xl d-flex">
                                ...
                                <div class="flex-between gap-8 pt-24 border-top border-neutral-50 mt-28 border-dashed border-0">
                                    <h4 class="mb-0 text-main-two-600">300см</h4>
                                    <a href="#application" class="flex-align gap-8 text-main-600 hover-text-decoration-underline transition-1 fw-semibold" tabindex="0">
                                        Записатса
                                        <i class="ph ph-arrow-right"></i>
                                    </a>
                    ...
                    <div class="col-lg-4 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="400">
                        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                <a href="course-details.html" class="w-100 h-100">
                                    <img src="file/python.jpg" alt="Course Image" class="course-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="flex-align gap-8 bg-main-600 rounded-pill px-24 py-12 text-white position-absolute inset-block-start-0 inset-inline-start-0 mt-20 ms-20 z-1">
                                    <span class="text-2xl d-flex"><i class="ph ph-clock"></i></span>
                                    <span class="text-lg fw-medium">25h 06m</span>
                            ...
                            <div class="course-item__content">
                                <div class="">
                                    <h4 class="mb-28">
                                        <a href="course-details.html" class="link text-line-2">Python</a>
                                    </h4>
                                    <div class="flex-between gap-8 flex-wrap mb-16">
                    ...
                    <div class="col-lg-4 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="400">
                        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                <a href="course-details.html" class="w-100 h-100">
                                    <img src="file/cpp.png" alt="Course Image" class="course-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="flex-align gap-8 bg-main-600 rounded-pill px-24 py-12 text-white position-absolute inset-block-start-0 inset-inline-start-0 mt-20 ms-20 z-1">
                                    <span class="text-2xl d-flex"><i class="ph ph-clock"></i></span>
                                    <span class="text-lg fw-medium">25h 06m</span>
                            ...
                            <div class="course-item__content">
                                <div class="">
                                    <h4 class="mb-28">
                                        <a href="course-details.html" class="link text-line-2">Спартивное програмирование C++</a>
                                    </h4>
                                    <div class="flex-between gap-8 flex-wrap mb-16">
                    ...
                    <div class="col-lg-4 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="400">
                        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                            ...
                            <div class="course-item__content">
                                <div class="">
                                    <h4 class="mb-28">
                                        <a href="course-details.html" class="link text-line-2">Front-end,Html,Css,Js</a>
                                    </h4>
                                    <div class="flex-between gap-8 flex-wrap mb-16">
                    ...
                    <div class="col-lg-4 col-sm-6 wow fadeInUp" data-aos="fade-up" data-aos-duration="400">
                        <div class="course-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                            <div class="course-item__thumb rounded-12 overflow-hidden position-relative">
                                <a href="course-details.html" class="w-100 h-100">
                                    <img src="file/laravel_back.webp" alt="Course Image" class="course-item__img rounded-12 cover-img transition-2">
                                </a>
                                <div class="flex-align gap-8 bg-main-600 rounded-pill px-24 py-12 text-white position-absolute inset-block-start-0 inset-inline-start-0 mt-20 ms-20 z-1">
                                    <span class="text-2xl d-flex"><i class="ph ph-clock"></i></span>
                                    <span class="text-lg fw-medium">25h 06m</span>
                            ...
                            <div class="course-item__content">
                                <div class="">
                                    <h4 class="mb-28">
                                        <a href="course-details.html" class="link text-line-2">Back-end,Php,Laravel</a>
                                    </h4>
                                    <div class="flex-between gap-8 flex-wrap mb-16">
...
<!-- ================================ About Section Start ==================================== -->
<section class="about py-120 position-relative z-1 mash-bg-main mash-bg-main-two" id="about">
                        ...
                        <div class="flex-align flex-wrap gap-32 pt-40 border-top border-neutral-50 mt-40 border-dashed border-0" data-aos="fade-left" data-aos-duration="600">
                            ...
                            <div class="flex-align gap-20">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <span class="text-sm d-block">CEO компании Afzal</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="{{route('application.add')}}" method="post">
                                ...
                                <div class="mb-24 position-relative" data-aos="fade-up-left" data-aos-duration="800">
                                    <select name="course" class="bg-white text-black border border-transparent focus-border-main-600 h-48 rounded-pill px-16 ps-60 outline-0 w-100 text-neutral-300">
                                        ...
                                        <option value="Люкс - ателье">Люкс - ателье</option>
                                        <option value="C++ спортивное програмирование">C++ спортивное програмирование</option>
                                        <option value="Python">Python</option>
                                        <option value="Back-end Php">Back-end Php</option>
                                        <option value="Front-end">Front-end</option>
                                        <option value="Back-end Laravel">Back-end Laravel</option>
                                        <option value="Англисний язык">Англисний язык</option>
...
<footer class="footer bg-main-25 position-relative z-1" id="contact">
                ...
                <div class="col" data-aos="fade-up" data-aos-duration="300" >
                    <div class="footer-item">
                        <div class="footer-item__logo">
                            <a href="index.html"> <img src="file/logo_afzal.png" alt=""></a>
                        </div>
                        <p class="my-32">Afzal превзошёл все мои ожидания! Преподаватели были не просто экспертами,</p>

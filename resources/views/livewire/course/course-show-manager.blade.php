                    ...
                    <div class="border border-neutral-30 rounded-12 bg-main-25 p-32 mt-24">
                        <form wire:submit.prevent="addComment" id="commentForm" wire:key="addComment-form">
                            ...
                            <div class="mb-24">
                                ...
                                <input type="text" wire:model="name" class="common-input rounded-pill" id="name" placeholder="Enter Name...">
                            </div>
                            ...
                            <div class="mb-24">
                                ...
                                <textarea id="desc" wire:model="comment" class="common-input rounded-24" placeholder="Write you question..."></textarea>
                            </div>
                            <div class="mb-0">
